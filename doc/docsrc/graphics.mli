(* CE FICHIER EST ICI JUSTE POUR LA DOCUMENTATION, NE PAS ÉDITER SVP. *)
...
(* $Id: graphics.mli,v 1.1 2009-02-23 08:41:51 courtiep Exp $ *)

(** Le Module de graphisme, si [Graph_utils] ne suffit pas (ne pas modifier). 
    Copyright 1996 Institut National de Recherche en Informatique et
    en Automatique. All rights reserved. This file is distributed
    under the terms of the GNU Library General Public License, with
    the special exception on linking described in ocaml sources. *)
